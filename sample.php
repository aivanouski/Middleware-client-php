...
$query_filter = $client->addFilter("transfer", json_decode('{"symbol": "0x'. bytes32('TIME') .'"}'));
$query_add_account = $client->addAccount("0x096ee6177d6402979b5e3f17385c36231133c254");
